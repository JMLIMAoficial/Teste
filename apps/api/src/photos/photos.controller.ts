...
import { PhotosService, type PhotoRole } from './photos.service';
...
export class PhotosController {
  ...
  upload(
    ...
    return this.photosService.uploadForUser(user.id, file, parsePhotoRole(role));
  }
  ...
  @Patch(':id/profile')
  setProfile(@CurrentUser() user: AuthUser, @Param('id') id: string) {
    return this.photosService.setProfile(user.id, id);
  }
